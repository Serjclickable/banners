...
p.nominalBounds = new cjs.Rectangle(0,0,258,305);
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-28,3,2.05,2.05);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol8, new cjs.Rectangle(-28,3,528.8,625.1), null);
...
(lib.Symbol34 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:315.9},22,cjs.Ease.get(-1)).to({y:326},23,cjs.Ease.get(1)).to({y:316},23,cjs.Ease.get(-1)).to({y:306},23,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-28,3,528.8,625.1);
...
p.nominalBounds = new cjs.Rectangle(-314.4,9,1070.8,788.1);
...
p.nominalBounds = new cjs.Rectangle(-135.6,-236.5,3463.7,1140.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1503400607657", id:"back"},
		{src:"images/Bestcontor.png?1503400607657", id:"Bestcontor"},
		{src:"images/button.png?1503400607657", id:"button"},
		{src:"images/donottouch.png?1503400607657", id:"donottouch"},
		{src:"images/e2017.png?1503400607657", id:"e2017"},
		{src:"images/fastpidr.png?1503400607657", id:"fastpidr"},
		{src:"images/gorilla.png?1503400607657", id:"gorilla"},
		{src:"images/logo.png?1503400607657", id:"logo"},
		{src:"images/money1.png?1503400607657", id:"money1"},
		{src:"images/money2.png?1503400607657", id:"money2"},
		{src:"images/people.png?1503400607657", id:"people"},
		{src:"images/pidr.png?1503400607657", id:"pidr"},
		{src:"images/shop1.png?1503400607657", id:"shop1"},
		{src:"images/tank.png?1503400607657", id:"tank"}
	],
	preloads: []
};

...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({scaleX:0.98,scaleY:0.98,x:115.6,y:33.6},2,cjs.Ease.get(-1)).to({scaleX:0.94,scaleY:0.94,y:33.5},3,cjs.Ease.get(1)).to({regX:115.6,scaleX:0.96,scaleY:0.96,x:115.7,y:33.6},2,cjs.Ease.get(-1)).to({regX:115.5,scaleX:1,scaleY:1,x:115.5,y:33.5},3,cjs.Ease.get(1)).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1502896184031", id:"back"},
		{src:"images/Bestcontor.png?1502896184031", id:"Bestcontor"},
		{src:"images/blackp.png?1502896184031", id:"blackp"},
		{src:"images/button.png?1502896184031", id:"button"},
		{src:"images/e2017.png?1502896184031", id:"e2017"},
		{src:"images/fastpidr.png?1502896184031", id:"fastpidr"},
		{src:"images/gorilla.png?1502896184031", id:"gorilla"},
		{src:"images/logo.png?1502896184031", id:"logo"},
		{src:"images/money.png?1502896184031", id:"money"},
		{src:"images/money2.png?1502896184031", id:"money2"},
		{src:"images/nottouch.png?1502896184031", id:"nottouch"},
		{src:"images/people.png?1502896184031", id:"people"},
		{src:"images/pidr.png?1502896184031", id:"pidr"},
		{src:"images/shopn.png?1502896184031", id:"shopn"},
		{src:"images/tank.png?1502896184031", id:"tank"}
	],
	preloads: []
};

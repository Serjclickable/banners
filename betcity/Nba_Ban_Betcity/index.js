...
(lib.блокировок = function() {
	this.initialize(img.блокировок);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,253,26);


(lib.Быстрые = function() {
	this.initialize(img.Быстрые);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,190,32);


(lib.выплаты = function() {
	this.initialize(img.выплаты);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,185,28);


(lib.высокие = function() {
	this.initialize(img.высокие);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,251,33);


(lib.коэффициенты = function() {
	this.initialize(img.коэффициенты);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,264,25);


(lib.настройки = function() {
	this.initialize(img.настройки);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,245,35);


(lib.никаких = function() {
	this.initialize(img.никаких);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,34);


(lib.удобные = function() {
	this.initialize(img.удобные);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,238,41);// helper functions:
...
(lib.Symbol11 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.настройки();
	this.instance.parent = this;
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.блокировок();
	this.instance.parent = this;
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.коэффициенты();
	this.instance.parent = this;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1509008982151", id:"back"},
		{src:"images/blick.png?1509008982151", id:"blick"},
		{src:"images/btn.png?1509008982151", id:"btn"},
		{src:"images/ColorBalance1.png?1509008982151", id:"ColorBalance1"},
		{src:"images/Layer15.png?1509008982151", id:"Layer15"},
		{src:"images/Layer18.png?1509008982151", id:"Layer18"},
		{src:"images/Layer6.png?1509008982151", id:"Layer6"},
		{src:"images/Layer7.png?1509008982151", id:"Layer7"},
		{src:"images/polosa.png?1509008982151", id:"polosa"},
		{src:"images/блокировок_.png?1509008982151", id:"блокировок"},
		{src:"images/Быстрые_.png?1509008982151", id:"Быстрые"},
		{src:"images/выплаты_.png?1509008982151", id:"выплаты"},
		{src:"images/высокие_.png?1509008982151", id:"высокие"},
		{src:"images/коэффициенты_.png?1509008982151", id:"коэффициенты"},
		{src:"images/настройки_.png?1509008982151", id:"настройки"},
		{src:"images/никаких_.png?1509008982151", id:"никаких"},
		{src:"images/удобные_.png?1509008982151", id:"удобные"}
	],
	preloads: []
};

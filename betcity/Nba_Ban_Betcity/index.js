...
(lib.monn = function() {
	this.initialize(img.monn);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,290,44);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.monn();
	this.instance.parent = this;
	this.instance.setTransform(-3,3,0.917,0.917);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(-3,3,266,40.4), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({x:291,y:454},74).to({x:674,y:326},9,cjs.Ease.cubicIn).wait(285).to({x:-346.9,y:631},0).wait(1).to({x:274,y:468},10,cjs.Ease.cubicOut).to({x:274.7,y:467.3},5).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1509010566525", id:"back"},
		{src:"images/blick.png?1509010566525", id:"blick"},
		{src:"images/block.png?1509010566525", id:"block"},
		{src:"images/btn.png?1509010566525", id:"btn"},
		{src:"images/carry.png?1509010566525", id:"carry"},
		{src:"images/coeficie.png?1509010566525", id:"coeficie"},
		{src:"images/fast.png?1509010566525", id:"fast"},
		{src:"images/hight.png?1509010566525", id:"hight"},
		{src:"images/Layer15.png?1509010566525", id:"Layer15"},
		{src:"images/Layer18.png?1509010566525", id:"Layer18"},
		{src:"images/Layer6.png?1509010566525", id:"Layer6"},
		{src:"images/Layer7.png?1509010566525", id:"Layer7"},
		{src:"images/monn.png?1509010566525", id:"monn"},
		{src:"images/nonono.png?1509010566525", id:"nonono"},
		{src:"images/polosa.png?1509010566525", id:"polosa"},
		{src:"images/rele.png?1509010566525", id:"rele"},
		{src:"images/set.png?1509010566525", id:"set"}
	],
	preloads: []
};

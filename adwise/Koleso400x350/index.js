...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(60).call(this.frame_60).wait(61));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({rotation:-88.9},0).wait(1).to({rotation:-85.4,x:191.1},0).wait(1).to({rotation:-79.7,x:191},0).wait(1).to({rotation:-71.6,x:191.1},0).wait(1).to({rotation:-61.3},0).wait(1).to({rotation:-48.7,x:191},0).wait(1).to({rotation:-33.7},0).wait(1).to({rotation:-16.6},0).wait(1).to({rotation:3,y:191.1},0).wait(1).to({rotation:24.8,y:191},0).wait(1).to({rotation:48.9,y:191.1},0).wait(1).to({rotation:75.3},0).wait(1).to({rotation:104,y:191},0).wait(1).to({rotation:135},0).wait(1).to({rotation:168.3},0).wait(1).to({rotation:203.9},0).wait(1).to({rotation:241.7},0).wait(1).to({rotation:281.9,x:191.1},0).wait(1).to({rotation:324.4,x:191},0).wait(1).to({rotation:369.2},0).wait(1).to({rotation:416.3},0).wait(1).to({rotation:465.6},0).wait(1).to({rotation:517.2},0).wait(1).to({rotation:571.2},0).wait(1).to({rotation:627.5},0).wait(1).to({rotation:686,x:191.1},0).wait(1).to({rotation:746.8,x:191},0).wait(1).to({rotation:810},0).wait(1).to({rotation:692},0).to({_off:true},1).wait(30).to({_off:false,regX:189.3,regY:189.5,scaleX:1,scaleY:1,rotation:512.4,x:192.7,y:191.1},0).wait(1).to({regX:191,regY:191,scaleX:1,scaleY:1,rotation:513.1,x:190.5,y:190.5},0).wait(1).to({rotation:515.3,x:190.4,y:190.3},0).wait(1).to({rotation:518.8,x:190.5,y:190.2},0).wait(1).to({rotation:523.8,x:190.6,y:190},0).wait(1).to({rotation:530.2,x:190.7,y:189.8},0).wait(1).to({rotation:538,x:190.9,y:189.6},0).wait(1).to({rotation:547.2,x:191.1,y:189.4},0).wait(1).to({rotation:557.8,x:191.5,y:189.1},0).wait(1).to({rotation:569.8,x:191.9,y:188.9},0).wait(1).to({rotation:583.3,x:192.4,y:188.8},0).wait(1).to({rotation:598.2,x:193},0).wait(1).to({rotation:614.5,x:193.6,y:189},0).wait(1).to({rotation:632.2,x:194.2,y:189.4},0).wait(1).to({rotation:651.3,x:194.7,y:190},0).wait(1).to({rotation:671.9,x:194.9,y:190.8},0).wait(1).to({rotation:693.9,x:194.8,y:191.6},0).wait(1).to({rotation:717.2,x:194.4,y:192.4},0).wait(1).to({rotation:742,x:193.6,y:193.1},0).wait(1).to({rotation:768.3,x:192.6,y:193.3},0).wait(1).to({rotation:795.9,x:191.6,y:193.1},0).wait(1).to({rotation:825,x:190.7,y:192.3},0).wait(1).to({rotation:855.4,x:190.4,y:191.2},0).wait(1).to({rotation:887.3,x:190.6,y:189.9},0).wait(1).to({rotation:920.6,x:191.6,y:189},0).wait(1).to({rotation:955.3,x:192.9,y:188.8},0).wait(1).to({rotation:991.5,x:194.2,y:189.4},0).wait(1).to({rotation:1029,x:194.9,y:190.6},0).wait(1).to({rotation:1068,x:194.6,y:192.2},0).wait(1).to({rotation:1108.4,x:193.4,y:193.2},0).wait(1).to({regX:190.5,regY:190.6,rotation:1259.7,x:190.9,y:191.1},0).to({_off:true},1).wait(30));
...
// library properties:
lib.properties = {
	id: '5BFFF050D4C144ED8DB4241DF99B0E03',
	width: 600,
	height: 300,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/baraban.png?1508510745814", id:"baraban"},
		{src:"images/bif.jpg?1508510745814", id:"bif"},
		{src:"images/casinox.png?1508510745814", id:"casinox"},
		{src:"images/golden.png?1508510745814", id:"golden"},
		{src:"images/strelka.png?1508510745814", id:"strelka"},
		{src:"sounds/kolesowav.mp3?1508510745814", id:"kolesowav"}
	],
	preloads: []
};
...
an.compositions['5BFFF050D4C144ED8DB4241DF99B0E03'] = {
